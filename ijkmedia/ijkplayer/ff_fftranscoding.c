...
//  IJKMediaFramework
//
//  Created by chencancan on 2021/5/28.
...
int ffp_transcoding_file(const char *in_file,const char *out_file) {
    ...
    if (in_file == NULL || out_file == NULL) {
        av_log(NULL, AV_LOG_ERROR, "Usage: <input file>: %s <output file>: %s\n", in_file, out_file);
        return 1;
    }
    av_register_all();
